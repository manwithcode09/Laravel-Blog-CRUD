    ...
    <table class="table table-striped table-sm">
      ...
      <tbody>
        ...
        <tr>
            ...
            <a href="/dashboard/posts/{{ $post->slug }}" class="badge view"><span data-feather="eye"></span></a>
            {{-- URL ini akan otomatis ditangani oleh method edit didalam resource controller --}}
            <a href="/dashboard/posts/{{ $post->slug }}/edit" class="badge edit"><span data-feather="edit"></span></a>
